...
namespace alice2 {
    ...
    public:
        ...
        Mat4 getCurrentModelViewProjectionMatrix() const;
        ...
        // Mesh rendering
        void drawMesh(const Vec3* vertices, const Vec3* normals, const Vec3* colors, int vertexCount,
                     const int* indices, int indexCount, bool enableLighting = true);
        void drawMeshWireframe(const Vec3* vertices, const Vec3* colors, int vertexCount,
    ...
    private:
        ...
        // Current camera reference (for matrix access)
